...
--     CONSTRAINT fk_complaints_comment_id FOREIGN KEY (comment_id) REFERENCES complaints (id) ON DELETE CASCADE,
--     CONSTRAINT fk_complaints_sender_id FOREIGN KEY (sender_id) REFERENCES users (id) ON DELETE CASCADE
-- );
--
-- CREATE INDEX IF NOT EXISTS fk_complaints_index_comment_id ON complaints (comment_id);
-- CREATE INDEX IF NOT EXISTS fk_complaints_index_sender_id ON complaints (sender_id);